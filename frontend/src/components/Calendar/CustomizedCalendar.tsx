...
// import { VIEW_OPTIONS, RESOURCES, EVENTS } from "@/types/calendar/constants";
...
//                     {VIEW_OPTIONS.map(({ id, label }: { id: any, label: string }) => (
//                         <Button key={id}
//                             onClick={() => setView(id)}
//                             {...(id === view
//                                 ? {
...
//                                         )?.format("DD/MM/YYYY hh:mm a")} for resource ${RESOURCES.find(
//                                             (resource: any) =>
